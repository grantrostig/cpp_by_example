...
bool Singleton_gof_registry::add_singleton( std::string const & name, Singleton_gof_registry * singleton_ptr) { cout << "add_singleton()."<<endl;
...
Singleton1 * Singleton1::instance( std::string const & name ) {
    ...
    return static_cast<Singleton1 *>(singleton_gof_registry);
};
