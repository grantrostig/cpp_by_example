...
// IGNORE, this is just a backup copy.
...
protected:          ~Singleton_gof_registry()                                             noexcept      =default;
    explicit  Singleton_gof_registry() { _name_COLLISION_with_derived = "name init in Singleton base constructor:"; cout <<"Construct base."<<endl; }
...
public:     static  bool                        add_singleton( std::string const & name, Singleton_gof_registry * singleton_ptr);  // Called "register" in GOF book we don't want keyword in a name.
    ...
    string                      _name_COLLISION_with_derived {"singleton_got_registry_name"}; // Just testing the idea of having this data member. TODO??: Is it permissable for this to be non-static?
...
void test_singleton_gof_registry() {
    ...
    cout << my_singleton1->_name_COLLISION_with_derived <<endl;
